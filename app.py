...
st.write(
"""
This AI system detects Parkinson’s Disease using three inputs:
- 🎤 Speech analysis
...
# =============================
st.header("✍️ Handwriting Detection")
